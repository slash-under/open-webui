    ...
    **kwargs,
    ...
    if engine == "ollama":
        ...
        if isinstance(text, list) and len(text) > embedding_batch_size:
            ...
            log.info(f"This portion of code is untrustworthy. This function caller claims only {len(text)}, however the contents are actually being processed here for large documents.")
